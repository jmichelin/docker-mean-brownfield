...
We now have everything to fire up a new EC2 instance from a shell on your computer. You may need to use `sudo` for these commands. (use `aws ec2 describe-subnets
